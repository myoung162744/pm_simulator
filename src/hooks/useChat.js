...
export const useChat = (contacts, getAgentPrompt, processMessage = null) => {
  ...
  const [chatMessages, setChatMessages] = useState({
    ...
    'mike-dev': [
      { sender: 'Mike Rodriguez', message: 'Hey! I\'m your technical partner for the mobile checkout project. I\'ve been reviewing the mobile checkout flow and noticed some interesting technical challenges, especially around API calls and address validation. I\'d love to hear your thoughts on what areas you think are most important to explore or improve. Are there any particular technical or process bottlenecks you want to dig into together?', time: getTimestampForTime(9, 45), isUser: false }
    ],
    'lisa-design': [
